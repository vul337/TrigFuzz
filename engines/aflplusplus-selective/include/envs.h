...
static char *afl_environment_variables[] = {
    ...
    "AFL_ALIGNED_ALLOC", "AFL_ALLOW_CORES", "AFL_ALLOW_TMP", "AFL_ANALYZE_HEX",
    "AFL_AS", "AFL_AUTORESUME", "AFL_AS_FORCE_INSTRUMENT", "AFL_BENCH_JUST_ONE",
    ...
    "AFL_FORCE_FASTRESUME", "AFL_FRIDA_DEBUG_MAPS", "AFL_FRIDA_DRIVER_NO_HOOK",
    ...
    "AFL_IJON_HISTORY_LIMIT", "AFL_IJON_RETIRE_MAX", "AFL_INPUT_PLACEHOLDER",
    ...
    "AFL_LLVM_SKIPSINGLEBLOCK", "AFL_LLVM_IJON", "AFL_LLVM_DENY_EXEC",
    ...
    "AFL_LLVM_NGRAM_SIZE", "AFL_NGRAM_SIZE", "AFL_LLVM_NO_RPATH",
    "AFL_LLVM_LTO_PATH", "AFL_LLVM_PATH", "AFL_LLVM_PATH_MODE",
    "AFL_LLVM_PATH_MAX_PATHS", "AFL_LLVM_NOT_ZERO", "AFL_LLVM_INSTRUMENT_FILE",
    ...
    "AFL_QEMU_MODE", "AFL_QEMU_BACKEND", "AFL_QEMU_CMPLOG_NO_RTN",
    ...
    "AFL_TMPDIR", "AFL_TOKEN_FILE", "AFL_TRACE_PC", "AFL_TRIGFUZZ_DEBUG",
    "AFL_TRIGFUZZ_ENABLE", "AFL_TRIGFUZZ_INS_NUM", "AFL_TRIGFUZZ_SEQ_NUM",
    "AFL_TRIGFUZZ_SELECTIVE", "AFL_TRIGFUZZ_SELECTIVE_FILE",
    "AFLGO_SELECTIVE_FILE",
    "AFL_USE_ASAN",
    ...
    "AFL_FORKSRV_GID", "AFL_COMPILER_LAUNCHER", "AFL_FRAMESHIFT_DISABLE",
    "AFL_FRAMESHIFT_MAX_OVERHEAD", "AFL_OLD_CHILD_SYNC", "AFL_CHILD_SYNC_SHM",
